#!/bin/bash                                     #Code :R@z@R
#İnstagram : @razor_account                  #Bu toolun kullanımında meydana gelicek hiç bir şey sorumluluğumda değildir!Kişi yaptığı tüm işlerden kendisi sorumludur!
#R@z@R,ZEUSHKN
banner_sm(){
