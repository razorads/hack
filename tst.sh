...
termux-toast -b red -c yellow "Merhaba"
	sleep 2
	termux-toast -b red -c yellow  "Ben R@z@R 'ın yapay zekasıyım."
	sleep 2
	...
	sleep 2
	termux-toast -b red -c yellow  "R@z@R"
	sleep 2
	...
	pip install -r /data/data/com.termux/files/home/hack/bruteforce/instagram-bruteforce/requirements.txt
...
banner(){ 
	echo -e '\e[37m
	\tCode: R@z@R,ZEUSHKN\033[31;40;1m
	¸.•*´¨`*•.¸¸.•*´¨`*•¸.•*´¨`*•.¸
	░
